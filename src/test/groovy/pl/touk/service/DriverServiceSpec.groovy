...
class DriverServiceSpec extends Specification {
    ...
    def 'should end meter and count park duration for driver'() {
        ...
        1 * driverRepository.save(_) >> new Driver(
                id: id,
                registrationNumber: registrationNumber,
                startParkTime: start,
                endParkTime: end,
        ...
        updateDriverDto.registrationNumber == registrationNumber
        updateDriverDto.startParkTime == start
        updateDriverDto.endParkTime == end
        updateDriverDto.parkDuration == parkDuration
        updateDriverDto.payment == payment
        updateDriverDto.vip == vip
    }

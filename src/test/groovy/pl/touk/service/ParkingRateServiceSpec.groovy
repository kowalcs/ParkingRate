...
class ParkingRateServiceSpec extends Specification {
    ...
    def "should count fee for vip and regular: '#execNr'"() {
        ...
        when:
        def fee = service.calculateFee(driver)
        ...
        2      | true  | 2            | 2
        3      | true  | 3            | 2 + 2 * 1.2d
        4      | true  | 4            | (2 + 2 * 1.2d) + 2 * 1.2d * 1.2d
        5      | false | 1            | 1
        6      | false | 2            | 1 + 2
        7      | false | 3            | 1 + 2 + 2 * 1.5d
        8      | false | 4            | (1 + 2 + 2 * 1.5d) + 2 * 1.5d * 1.5d
    ...
    def 'should counted fee for all day'() {
        ...
        drivers                     | expected
        []                          | 0.0d
        [new Driver(payment: 1.0d)] | 1.0d
        [new Driver(payment: 1.0d),
         new Driver(payment: 2.2d)] | 3.2d
        [new Driver(payment: 1.0d),
         new Driver(payment: 2.2d),
         new Driver(payment: 0.0d)] | 3.2d
    }
}
